    ...
    <div className="font-sans text-[#1a1a1a] min-h-screen px-4 md:px-10 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 bg-[#006951] p-7 rounded-[2.5rem] text-white shadow-sm">
          ...
          <h2 className="text-[48px] md:text-[56px] font-bold leading-none mb-4 tracking-tighter">24</h2>
        ...
        {[
          ...
          <div key={idx} className="lg:col-span-3 bg-white p-7 rounded-[2.5rem] border border-gray-100 shadow-sm">
            <div className="flex justify-between items-start mb-2">
            ...
            <h2 className="text-[48px] md:text-[56px] font-bold leading-none mb-4 tracking-tighter">{item.value}</h2>
        ...
        {/* Using a nested grid logic for tablet/desktop consistency */}
        ...
        <div className="md:col-span-2 lg:col-span-8 grid grid-cols-1 md:grid-cols-8 gap-6">
                ...
                <div className="flex items-end justify-between gap-2 md:gap-3 px-1 h-32 mb-2">
                    {[
                      ...
                      <div key={i} className="flex flex-col items-center gap-3 flex-1">
                        <div 
                          className={`w-full max-w-8 md:max-w-10 rounded-full relative ${bar.bg || ""}`} 
                          style={{ 
                            height: bar.h, 
                        ...
                        <div key={i} className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="leading-tight">
                                    ...
                                    <p className="text-[11px] text-gray-400 font-bold truncate w-24 md:w-auto">Working on Github...</p>
                                </div>
                            </div>
                            <span className="hidden sm:block text-[9px] font-black px-2 py-1 rounded uppercase bg-emerald-50 text-emerald-600 border border-emerald-100">Completed</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="md:col-span-4 bg-white p-7 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-center overflow-hidden">
                ...
                <div className="relative w-48 md:w-64 h-24 md:h-32 flex justify-center items-end overflow-hidden">
                    ...
                    <div 
                        className="absolute w-48 h-48 md:w-64 md:h-64 border-[24px] md:border-[32px] border-[#006951] rounded-full bottom-[-96px] md:bottom-[-128px]"
                        style={{ clipPath: 'polygon(0 0, 85% 0, 85% 50%, 0 50%)', transform: 'rotate(-10deg)' }}
                    ></div>
                    <div className="absolute bottom-1 w-full text-center">
                        <h2 className="text-[32px] md:text-[48px] font-black text-gray-900 leading-none tracking-tighter">41%</h2>
                        <p className="text-[10px] md:text-[11px] font-bold text-[#006951] uppercase tracking-widest mt-1">Project Ended</p>
                    </div>
                </div>
                <div className="flex flex-wrap justify-center gap-3 md:gap-4 mt-8 md:mt-12">
                    <div className="flex items-center gap-1.5 text-[9px] md:text-[10px] font-black text-gray-400">
                        <div className="w-2 h-2 bg-[#006951] rounded-full"></div> COMPLETED
                    </div>
                    <div className="flex items-center gap-1.5 text-[9px] md:text-[10px] font-black text-gray-400">
                        <div className="w-2 h-2 bg-[#013326] rounded-full"></div> PROGRESS
                    </div>
                </div>
            </div>
        </div>

        {/* --- Right Column (Projects & Tracker) --- */}
                ...
                <div className="space-y-6">
                    {[
                        ...
                        <div key={i} className="flex items-center gap-4 group cursor-pointer">
                            <div className={`w-3 h-3 rounded-full ${p.icon} flex-shrink-0 group-hover:scale-110 transition-all`}></div>
                            <div className="flex-grow min-w-0">
                                ...
                                <p className="text-[11px] text-gray-400 font-bold opacity-70">Due: {p.date}</p>
                            </div>
                        </div>
                    ))}
                </div>
