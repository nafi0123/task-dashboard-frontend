...
const DashboardSkeleton = () => {
  return (
    <div className="font-sans bg-[#fdfdfd] min-h-screen px-10 py-6 animate-pulse">
      {/* --- Header Skeleton --- */}
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          ...
          <div className="h-12 w-32 bg-gray-100 rounded-full border border-gray-200"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="col-span-3 h-48 bg-white p-7 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col justify-between"
          >
        ...
        <div className="col-span-8 grid grid-cols-8 gap-6">
          ...
          <div className="col-span-5 bg-white p-7 rounded-[2.5rem] border border-gray-100 shadow-sm">
            ...
            <div className="flex items-end justify-between gap-3 h-32 px-1">
              {[1, 2, 3, 4, 5, 6, 7].map((bar) => (
                ...
                >
                  <div
                    className="w-full max-w-10 bg-gray-100 rounded-full"
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4].map((u) => (
                <div key={u} className="flex items-center justify-between">
                  ...
                  <div className="h-4 w-14 bg-gray-50 rounded"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="col-span-4 bg-white p-7 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-center">
            ...
            <div className="relative w-48 h-24 bg-gray-100 rounded-t-full mt-4">
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-16 bg-white rounded-t-full"></div>
            </div>
        ...
        <div className="col-span-4 flex flex-col gap-6">
          ...
          <div className="bg-gray-200 p-8 rounded-[2.5rem] h-64 flex flex-col justify-between">
            <div className="h-5 w-24 bg-gray-300 rounded"></div>
            <div className="space-y-6">
              <div className="h-14 w-40 bg-gray-300 rounded-lg mx-auto"></div>
